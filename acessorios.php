    ...
    <body>
        ...
        <div class="container">
           	...
           	<div class="child">
                ...
                <a href="guitarras.php"> <img class="input-icon" src="img/amplificador.png" width="200" height="200"> </a>
                <p>Amplificadores </p>
            </div>

            <div class="child">
                
                <a href="violoes.php"><img class="input-icon" src="img/microfone.png" width="200" height="200"></a> 
                <p>Microfones</p>
            </div>

            <div class="child">
             
                <a href="baixos.php"><img class="input-icon" src="img/fone.png" width="200" height="200"></a>
                <p>Fones</p>
            </div>

            <div class="child">
             
                <a href="baixos.php"><img class="input-icon" src="img/cabo.png" width="200" height="200"></a>
                <p>Cabos</p>
            </div>
